...
public interface SakeParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code nagasa}
	 * labeled alternative in {@link SakeParserParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNagasa(SakeParserParser.NagasaContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SakeParserParser#cube_attr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCube_attr(SakeParserParser.Cube_attrContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SakeParserParser#r_value}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitR_value(SakeParserParser.R_valueContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SakeParserParser#nagasa_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link SakeParserParser#one_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOne_param(SakeParserParser.One_paramContext ctx);
	/**
